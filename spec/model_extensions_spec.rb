...
describe ActsAsManyTenants do
  ...
  describe 'project tenants should be immutable' do
    ...
    it { -> { @project1.accounts = [@account3] }.should raise_error }
    it { -> { @project1.account_ids = [@account3.id] }.should raise_error }
  ...
  describe 'user tenants should not be immutable' do
    ...
    it { -> { @user1.accounts << @account2 }.should_not raise_error }
  end
